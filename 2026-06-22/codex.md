...
오늘 Codex의 새 안정 버전은 확인되지 않았습니다. `.version`에 저장된 앱 `26.616`, CLI `0.141.0`, 모바일 `1.2026.160` 기준을 유지합니다.

## GUI App

- 최신 앱 버전 저장 기준: `26.616`
- OpenAI Codex changelog의 최신 앱 항목도 `26.616` 기준입니다.
...
- npm에는 `0.142.0-alpha.9` alpha 태그가 있지만 안정 버전 기준 보고 대상은 아닙니다.
