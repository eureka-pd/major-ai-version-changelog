...
2026-08-11 확인 결과, 새 앱 버전은 없으며 Codex 일반 공지 1건을 기록합니다.
...
- 2026-08-10: 승인된 보안 담당자에게 Daybreak Blue와 Daybreak Red 접근 등급을 제공합니다.
- Blue는 일반 방어 작업용이고, Red는 별도 승인 후 침투 테스트·취약점 재현 같은 고위험 보안 검증 작업용입니다.
